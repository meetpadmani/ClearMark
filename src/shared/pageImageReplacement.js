...
export function emitPageImageProcessingStart({
  ...
  emitPageImageProcessEvent({
    logger,
    onLog,
    consoleMessage: '[ClearMark] page image process start',
  ...
  emitPageImageProcessEvent({
    logger,
    onLog,
    consoleMessage: '[ClearMark] page image process strategy',
...
export function applyPageImageProcessingResult({
  ...
  if (sourceResult?.skipped) {
    ...
    emitPageImageProcessEvent({
      logger,
      onLog,
      consoleMessage: '[ClearMark] page image process skipped',
  ...
  emitPageImageProcessEvent({
    logger,
    onLog,
    consoleMessage: '[ClearMark] page image process success',
...
export function handlePageImageProcessingFailure({
  ...
  emitPageImageProcessEvent({
    ...
    onLog,
    level: 'warn',
    consoleMessage: '[ClearMark] page image process failed',
