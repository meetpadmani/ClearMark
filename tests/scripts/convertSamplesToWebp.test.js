...
test('buildWebpOutputPath should write into a sibling webp directory with a webp extension', () => {
    const output = buildWebpOutputPath('D:\\Project\\clearmark\\src\\assets\\samples\\16-9.png');
    assert.equal(output, 'D:\\Project\\clearmark\\src\\assets\\samples\\webp\\16-9.webp');
});
