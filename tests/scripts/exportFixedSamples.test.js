...
test('buildFixedOutputPath should place outputs under a sibling fix directory', () => {
    const output = buildFixedOutputPath('D:\\Project\\clearmark\\src\\assets\\samples\\16-9.png');
    assert.equal(output, 'D:\\Project\\clearmark\\src\\assets\\samples\\fix\\16-9.png');
});
