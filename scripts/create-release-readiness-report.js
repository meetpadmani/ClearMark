...
const DEFAULT_INPUTS = Object.freeze({
    ...
    userscript: 'dist/userscript/clearmark.user.js',
...
function summarizeUserscriptArtifact(userscriptArtifact, packageArtifact, { mtimeOverrides = {} } = {}) {
    ...
    if (!metadata.downloadURL?.includes('clearmark.user.js')) blockers.push('userscript-download-url-missing');
    if (!metadata.updateURL?.includes('clearmark.user.js')) blockers.push('userscript-update-url-missing');
